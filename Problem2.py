...
# create C2
C2 = ChanceNode('C2', 25, [T1, T2], [0.7, 0.3])
# create C1
C1 = ChanceNode('C1', 35, [C2, T3], [0.2, 0.8])
# create C3
C3 = ChanceNode('C3', 45, [T4, T5], [0.1, 0.9])

# create D1
cost = DecisionNode('D1', 0, [C1, C3])

# print the expect cost of C1
print(cost.get_expected_costs())


#health utility
T1 = TerminalNode('T1', 0.9)
T2 = TerminalNode('T2', 0.8)
T3 = TerminalNode('T3', 0.7)
T4 = TerminalNode('T4', 0.6)
T5 = TerminalNode('T5', 0.5)

# create C2
C2 = ChanceNode('C2', 0, [T1, T2], [0.7, 0.3])
# create C1
C1 = ChanceNode('C1', 0, [C2, T3], [0.2, 0.8])
# create C3
C3 = ChanceNode('C3', 0, [T4, T5], [0.1, 0.9])

# create D1
healthutility = DecisionNode('D1', 0, [C1, C3])

# print the expect cost of C1
print(healthutility.get_expected_costs())
